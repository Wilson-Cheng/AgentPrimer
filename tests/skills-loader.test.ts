...
describe('skills loader (SKILL.md format)', () => {
  it('loads enabled skills and returns their context', async () => {
    ...
    upsertSkill({
      id: 'skill-1',
      name: 'hello-world',
      github_url: 'builtin://hello-world',
      local_path: skillDir,
      enabled: 1,
      manifest_json: VALID_SKILL_MD,
    });
  ...
  it('filters skills by name and skips disabled skills', async () => {
    ...
    upsertSkill({
      id: 'sk-2',
      name: 'code-reviewer',
      github_url: 'builtin://code-reviewer',
      local_path: skillDir2,
      enabled: 1,
      manifest_json: '',
    });
    upsertSkill({
