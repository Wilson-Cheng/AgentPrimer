    ...
    <main className="flex-1 overflow-y-auto bg-white dark:bg-gray-950">
        ...
        <div className="max-w-3xl mx-auto px-8 py-8 space-y-6">
          ...
          <div className="flex gap-3 bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/50 rounded-xl px-4 py-3 text-sm text-blue-700 dark:text-blue-300">
            ...
            <p>
              Revoking an approval takes effect <strong>immediately</strong> across all open
              sessions — the agent will start asking for confirmation again the next time it
              tries to perform that operation.
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm max-w-sm">
                When the agent asks for permission and you click{' '}
                <em>&quot;Always approve&quot;</em>, it will appear here.
              </p>
            </div>
          ) : (
